...
‎   };
‎
‎   if ((event.body.toLowerCase() == "miss you") || (event.body.toLowerCase() == "mc")) {
...
‎   };
‎
‎if ((event.body.toLowerCase() == "খাইতে জাবো") || (event.body.toLowerCase() == "good night")) {
‎     return api.sendMessage("GOOD NIGHT দাত ব্রাশ করে ঘুমিয়ে জাও 😚", threadID);
‎   };
‎
...
‎   };
‎
‎  if ((event.body.toLowerCase() == "nahid") || (event.body.toLowerCase() == "NAHID DADU") || (event.body.toLowerCase() == "@Nahidッ") || (event.body.toLowerCase() == "dadu")) {
...
‎     return api.sendMessage("[𝐎𝐖𝐍𝐄𝐑:☞ NAHID ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=61579419327684\nতার সাতে যোগা যোগ করবেন WhatsApp :- 01790454254", threadID);
‎   };
‎
...
‎     return api.sendMessage("He is NAHIDッ❤️ তাকে সবাই নাহিদ হাসান  নামে  চিনে🤙", threadID);
‎   };
‎
...
‎   };
‎
‎   if ((event.body.toLowerCase() == "sala ami tor boss nahid") || (event.body.toLowerCase() == "sala ami nahid") || (event.body.toLowerCase() == "cup sala ami nahid") || (event.body.toLowerCase() == "নাহিদ আমি")) {
‎     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
‎   };
‎
‎   if ((event.body.toLowerCase() == "@raisha islam Rafa") || (event.body.toLowerCase() == "@রাইসা ইসলাম রাফা ")) {
‎     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস নাহিদ এর বউ এর আইড়ি😠🥰⛏️", threadID);
‎   };
‎
‎  if ((event.body.toLowerCase() == "mariya") || (event.body.toLowerCase() == "mariya akter mim")) {
...
‎   };
‎
‎  if ((event.body.toLowerCase() == "@স্বপ্ন আমার  ") || (event.body.toLowerCase() == "মুহিন")) {
‎     return api.sendMessage("🥰-মুহিন-🌺 আমার বস নাহিদ'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
‎   };
‎
...
‎     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে গার্লফ্রেন্ড টা দিয়ে দে আমার বস কে..!🌚⛏️🌶️", threadID);
‎   };
‎
...
‎   };
‎
‎   if ((event.body.toLowerCase() == "সালমা") || (event.body.toLowerCase() == "ex")) {
...
‎   };
‎
‎   if ((event.body.toLowerCase() == "ami nahid") || (event.body.toLowerCase() == "kire")) {
