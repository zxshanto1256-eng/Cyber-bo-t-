...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "oi kire" "ওই কিরে") || (event.body.toLowerCase() == "oi keray") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
  ...
  if ((event.body.toLowerCase() == "SHAHADAT") || (event.body.toLowerCase() == "SHAHADAT bai") || (evendy.toLowerCase() == "@SHAHADAT ッ") || (event.body.toLowerCase() == "শাহাদাত")) {
