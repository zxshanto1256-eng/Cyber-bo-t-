...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "nahid") || (event.body.toLowerCase() == "নাহিদ") || (event.body.toLowerCase() == "@nahid") || (event.body.toLowerCase() == "nahid dadu")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor nahid ") || (event.body.toLowerCase() == "sala ami nahid") || (event.body.toLowerCase() == "cup sala ami nahid") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "@স্বপ্ন আমার ") || (event.body.toLowerCase() == "মুহিন")) {
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝗜𝘀𝗹𝗮𝗺𝗶𝗰𝗸 𝗰𝗵𝗮𝘁 𝗯𝗼𝘁 zara", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "mariya") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("I LOVE YOU TO XAN💛🥰", threadID);
   };
