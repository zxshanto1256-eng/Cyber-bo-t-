...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "🫦") || (event.body.toLowerCase() == "💋")) {
     return api.sendMessage("কিরে  লুচ্চা, এগুলো কি ইমুজি দেস ।", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "namaj") || (event.body.toLowerCase() == "নামাজ")) {
     return api.sendMessage("~ সবাই ৫ ওয়াক্ত নামাজ আদায় করবে ?? 🤖", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "hum")) {
     return api.sendMessage("️হুম বলো না মাথা এমনিতেই গরম আছে🤬⛏️😷", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "BOT ER BACCHA") || (event.body.toLowerCase() == "বটের এর বাচ্চা")) {
     return api.sendMessage("️আমাকে বটের বাচ্চা বলো না..!!🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ajan") || (event.body.toLowerCase() == "আযান")) {
     return api.sendMessage("️আযান দিলে সবাই মসজিদে নামাজের জন্য জেও🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "😸") || (event.body.toLowerCase() == "😹")) {
     return api.sendMessage("তুমি এত হেসো না দাঁত খুলে পড়ে যাবে অল্প বয়সে বুড়ো হয়ে যাবে🌚🤣", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("আমি সব সময় আল্লাহ কে ভালবাসি I love you Allah 🥰💕🥱", threadID);
   };
